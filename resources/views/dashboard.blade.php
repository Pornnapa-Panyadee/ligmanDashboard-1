...
@section('content')
                            ...
                            <div class="tab-content">
                              ...
                              <div class="icon_dash" >
                                ...
                                <p style="margin-top:-5px;">{{ __('Beacon Glow Blue') }}</p>
                                        ...
                                        <div class="col-4">
                                            <div class="icon_dash">
                                                <i id="emergency" class="material-icons text-success"
                                                    style="font-size:50px;">notifications</i>
                                  ...
                                  <script>
                                    $(document).ready(function(){
                                        $('#live360').attr('src', 'http://10.2.4.54/ISAPI/Streaming/channels/101/httpPreview');
                                                        ...
                                                        <img id="live360" width="100%"
                                                            src="https://www.kindpng.com/picc/m/116-1165084_disconnect-png-transparent-png.png">
                                                    </div>
                                                </div>
                                                <div class="card-footer">
                                                    <div class="stats">
                                                        ...
                                                        <div class="dash-tri">
                                                            <span>{{ $devices_list[0]->pole_id }}</span>
                                                        </div>
                                                        <span
                                                            class="text_font">{{ __('Speed Dome Camera 360°') }}</span>
                                                        <div class="absolute">
                                                            <button id="btnlive360"
                                                                class="btn btn-offline btn-sm1">Offline</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-dash">
                                                ...
                                                <div class="card-footer">
                                                    <div class="stats">
                                                        <hr class="dash_status">
                                                        <div class="dash-tri">
                                                            <span>{{ $devices_list[1]->pole_id }}</span>
                                                        </div>
                                            ...
                                            <div class="card-dash">
                                                ...
                                                <div class="card-footer">
                                                    <div class="stats">
                                                        <hr class="dash_status">
                                                        <div class="dash-tri">
                                                            <span>{{ $devices_list[2]->pole_id }}</span>
                                                        </div>
                                                        <span
                                                            class="text_font">{{ __('License Plate Recognition') }}</span>
                                                        <div class="absolute1">
                                            ...
                                            <div class="card-dash">
                                                ...
                                                <div class="card-footer">
                                                    <div class="stats">
                                                        <hr class="dash_status">
                                                        <div class="dash-tri">
                                                            <span>{{ $devices_list[3]->pole_id }}</span>
                                                        </div>
                                                        <div class="absolute1">
                                                            <button id="btnface"
                                                                class="btn btn-offline btn-sm1">Offline</button>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashEs">
                                                                <a id="esave1" class="dash-link" href="#">
                                                                    <i class="icon-gauge text-orange"
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                ...
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[4]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnesave1"
                                                                        class="btn btn-offline btn-sm2">Offline</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashEs">
                                                                <a id="esave2" class="dash-link " href="#">
                                                                    <i class="icon-cluster_projectors text-orange"
                                                                        style="font-size:3vw;"></i>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[5]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnesave2"
                                                                        class="btn btn-offline btn-sm2">Offline</button>
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashEs">
                                                                <a id="esave3" class="dash-link " href="#">
                                                                    <i class="icon-cluster_projectors_ladar text-orange"
                                                                        style="font-size:3vw;"></i>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[6]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnesave3"
                                                                        class="btn btn-offline btn-sm2">Offline</button>
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashEs">
                                                                <a id="esave4" class="dash-link " href="#">
                                                                    <i class="icon-cloudy1 text-orange"
                                                                        style="font-size:3vw;"></i>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[7]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnesave4"
                                                                        class="btn btn-offline btn-sm2">Offline</button>
                                                ...
                                                <div class="col-md-2">
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashEs">
                                                                <a id="esave5" class="dash-link "
                                                                    href="{{ route('occupancy') }}">
                                                                    <i class="icon-occupancy text-orange"
                                                                        style="font-size:3vw;"></i>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[8]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnesave5"
                                                                        class="btn btn-offline btn-sm2">Offline</button>
                                                    ...
                                                    <div class="card-dash ">
                                                        <div class="card-header">
                                                            <div class="icon_dashAd">
                                                                <a id="exstreamer" class="dash-link " href="#">
                                                                    <i class="icon-bullhorn text-orange"
                                                                        style="font-size:4vw;"></i>
                                                                    <p class="icon_dashAd">Exstreamer <br>Loud Speaker
                                                                    </p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[9]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    {{-- <iframe id="loginexstreamer" style="display: none;" src={{$devices_list[10]->api_link}}></iframe> --}}
                                                                    <button id="btnexstreamer"
                                                                        class="btn btn-offline btn-sm3">Offline</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header ">
                                                            <div class="icon_dashAd">
                                                                <a id="instreamer" class="dash-link " href="#">
                                                                    <i class="icon-In-loud text-orange"
                                                                        style="font-size:4vw;"></i>
                                                                    <p class="icon_dashAd">Instreamer <br>Loud Speaker
                                                                    </p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[10]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <iframe id="logininstreamer" style="display: none;"
                                                                        src={{ $devices_list[11]->api_link }}></iframe>
                                                                    <button id="btninstreamer"
                                                                        class="btn btn-offline btn-sm3">Offline</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-dash">
                                                        <div class="card-header">
                                                            <div class="icon_dashAd">
                                                                <a id="digital" class="dash-link " href="#">
                                                                    <i class="icon-Digital_Signage text-orange"
                                                                        style="font-size:4vw;"></i>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[11]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                        ...
                                                        <div class="card-header">
                                                            <div class="icon_dashAd">
                                                                <a id="plug" class="dash-link " href="#">
                                                                    <i class="icon-power-plug text-orange"
                                                                        style="font-size:4vw;"></i>
                                                                    <p class="icon_dashAd">Round <br> Power Socket</p>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[12]->pole_id }}</span>
                                                                </div>
                                                                <div class="absolute1">
                                                                    <button id="btnplug"
                                                                        class="btn btn-offline btn-sm3">Offline</button>
                                          ...
                                          src="//umap.openstreetmap.fr/th-th/map/air-transmitter_595019?scaleControl=false&miniMap=false&scrollWheelZoom=false&zoomControl=null&allowEdit=false&moreControl=false&searchControl=null&tilelayersControl=null&embedControl=null&datalayersControl=false&onLoadPanel=undefined&captionBar=false#16/18.7953/458.9519">
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="stats">
                                                                <hr class="dash_status1">
                                                                <div class="dash-tri">
                                                                    <span>{{ $devices_list[13]->pole_id }}</span>
                                                                </div>
                                                                <span
                                                                    class="text_font">{{ __('Air Transmitter') }}</span>
                                                                <div class="absolute1">
                                                                    <button id="btnpmair"
                                                                        class="btn btn-offline btn-sm3">Offline</button>
                                                                </div>
    ...
    <script>
        (function() {
            ...
            setInterval(function() {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var date1 = new Date(JSON.parse(data).time);
                        var date2 = new Date();
            ...
            setInterval(function() {
                if (alert) {
                    if (document.getElementById('emergency').className == "material-icons text-success") {
                        document.getElementById('emergency').className = "material-icons text-danger";
                    } else {
                        document.getElementById('emergency').className = "material-icons text-success";
                    }
                }else{
                  document.getElementById('emergency').className = "material-icons text-success";
                }
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[0]['api_link'] != null) {
                        ...
                        document.getElementById('live360').src = devices_list[0]['api_link'] + devices_list[
                            0]['live_path'];
                        document.getElementById('btnlive360').className = "btn btn-success btn-sm1";
                        document.getElementById('btnlive360').onclick = function(ev) {
                            window.location = "{{ url('camera360') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[1]['api_link'] != null) {
                        document.getElementById('interimg').src = devices_list[1]['api_link'] +
                            ":8080/video.cgi";
                        document.getElementById('btninter').className = "btn btn-success btn-sm1";
                        document.getElementById('btninter').onclick = function(ev) {
                            window.location = "{{ url('intercom') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[2]['api_link'] != null) {
                        document.getElementById('licenseimg').src = devices_list[2]['api_link'] +
                            "/axis-cgi/mjpg/video.cgi";
                        document.getElementById('licenseimg').style.width = "77%";
                        document.getElementById('btnlicense').className = "btn btn-success btn-sm1";
                        document.getElementById('btnlicense').onclick = function(ev) {
                            window.location = "{{ url('camera_license') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[3]['api_link'] != null) {
                        ...
                        document.getElementById('faceimg').href = "{{ route('camera_face') }}";
                        document.getElementById('btnface').className = "btn btn-success btn-sm1";
                        document.getElementById('btnface').onclick = function(ev) {
                            window.location = "{{ url('camera_face') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[4]['api_link'] != null) {
                        ...
                        document.getElementById('btnesave1').onclick = function(ev) {
                            window.location = "{{ url('esave_dashboard') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[5]['api_link'] != null) {
                        ...
                        document.getElementById('btnesave2').onclick = function(ev) {
                            window.location = "{{ url('cluster_projector') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[6]['api_link'] != null) {
                        document.getElementById('esave3').href =
                            "{{ route('cluster_projector_lador') }}";
                        document.getElementById('btnesave3').className = "btn btn-success btn-sm2";
                        document.getElementById('btnesave3').onclick = function(ev) {
                            window.location = "{{ url('cluster_projector_lador') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[7]['api_link'] != null) {
                        ...
                        document.getElementById('btnesave4').onclick = function(ev) {
                            window.location = "{{ url('meteodata') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[8]['api_link'] != null) {
                        ...
                        document.getElementById('btnesave5').onclick = function(ev) {
                            window.location = "{{ url('occupancy') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[9]['api_link'] != null) {
                        ...
                        document.getElementById('btnexstreamer').onclick = function(ev) {
                            window.location = "{{ url('ex_speaker') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[10]['api_link'] != null) {
                        ...
                        document.getElementById('btninstreamer').onclick = function(ev) {
                            window.location = "{{ url('in_speaker') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[11]['api_link'] != null) {
                        ...
                        document.getElementById('btndigital').onclick = function(ev) {
                            window.location = "{{ url('digital_signage') }}";
                        };
            ...
            $.ajax({
                ...
                success: function() {
                    if (devices_list[12]['api_link'] != null) {
                        ...
                        document.getElementById('btnplug').onclick = function(ev) {
                            window.location = "{{ url('power_socket') }}";
                        };
    ...
    <script>
        function initMap() {
            ...
            var pm_names = ['good.png', 'moderate.png', 'unhealthy.png', 'unhealth_redy.png', 'veryunhealthy.png',
                'hazardous.png'
            ];
