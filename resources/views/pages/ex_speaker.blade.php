...
<script>
  window.frames["myFrame"].location = "http://admin:ligman@10.2.4.52/index.html";
</script>

<form name="inspeakForm" id="inspeakForm" method="POST" action="http://10.2.4.52/index.html" target="_blank"> 
